...
Numeric::solve_RK4_fixed_vortices(double dt, CartesianGridOfSpeed const &t_velocity, Geometry::CloudOfPoints const &t_points, int myrank, int nranks)
{
...
Numeric::solve_RK4_movable_vortices(double dt, CartesianGridOfSpeed &t_velocity,
                                    ...
                                    Geometry::CloudOfPoints const &t_points, int myrank, int nranks)
{
    constexpr double onesixth = 1. / 6.;
    using vector = Simulation::Vortices::vector;
    using point = Simulation::Vortices::point;
